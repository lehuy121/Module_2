...
public class Validation {
    ...
    public static final String USED_AND_POOL_AREA_PATTERN = "(^[3-9][\\d]{0,3}\\.+[1-9]{1,}|^[12][\\d]{2,3}\\.([\\d])*$)";
    ...
    public static final String GENDER_PATTERN = "^(?i:male|female|unknown)$";
    ...
    public static final String INVALID_INPUT_GENDER = "Invalid. Gender input";
    ...
    public static boolean isUsedArea_PoolArea(String s) {
        if (!(s.matches(USED_AND_POOL_AREA_PATTERN))) {
